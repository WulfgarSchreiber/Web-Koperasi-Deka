...
$sql = "SELECT id, nama_produk, stok, harga, gambar FROM produk WHERE kategori = 'Produk Dua Kelinci' AND stok > 0";
  ...
  <div class="collection_text">Produk Dua Kelinci</div>
    <div class="layout_padding collection_section">
        <div class="container">
                ...
                <p class="consectetur_text">Nikmati camilan lezat untuk setiap momen! Temukan berbagai pilihan snack gurih dan manis yang siap menemani hari Anda. Cek sekarang dan penuhi stok camilan favorit Anda! 😋</p>
        </div>
    </div>
										...
										<div class="best_shoes">
											...
											<div class="star_text">
												...
												<div class="buy_now_bt">
													<a type="button" href="action.cart.dk.php?action=add&id=<?= $data['id'] ?>" onclick="return confirm('Apakah anda ingin menambahkan produk ini?');"><img src="images/buynow.jpg"></a>
												</div>
											</div>
										</div>
									</div>
