...
$sqlPRT = "SELECT id, nama_produk, stok, harga, gambar FROM produk WHERE kategori = 'Peralatan Rumah Tangga' AND stok > 0";

if ($search) {
    $sqlPRT .= " AND nama_produk LIKE '%$search%'";
}

$resultPRT = $conn->query($sqlPRT);
...
<html lang="en">
  ...
  <div class="collection_text">Peralatan Rumah Tangga</div>
    <div class="layout_padding collection_section">
        <div class="container">
    		<h1 class="new_text"><strong>Selamat Datang di Koperasi Dua Kelinci</strong></h1>
    	    <p class="consectetur_text">Lengkapi rumah Anda dengan peralatan rumah tangga berkualitas! 🏡✨ Temukan berbagai produk praktis yang memudahkan aktivitas sehari-hari, dari peralatan dapur hingga kebutuhan kebersihan. Belanja mudah, rumah jadi lebih nyaman! 🛒</p>
    	</div>
    </div>
        ...
        <form method="GET" action="" class="mb-3">
			...
			<div class="container">
				<div class="row">
					<?php if ($resultPRT->num_rows > 0) {
								while ($data = $resultPRT->fetch_assoc()) {
									?>
									<div class="col-sm-4">
										<div class="best_shoes">
											...
											<div class="star_text">
												...
												<div class="buy_now_bt">
													<a type="button" href="action.cart.prt.php?action=add&id=<?= $data['id'] ?>" onclick="return confirm('Apakah anda ingin menambahkan produk ini?');"><img src="images/buynow.jpg"></a>
												</div>
											</div>
										</div>
									</div>
