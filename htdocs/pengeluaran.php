<?php 
    ...
    $query = "SELECT keluar.nproduk, keluar.tanggal, keluar.jumlah, keluar.keterangan, produk.nama_produk 
            FROM keluar 
            JOIN produk ON keluar.nproduk = produk.id";

    // Tampilkan data dengan filter tanggal
    if ($startDate && $endDate) {
        $query .= " WHERE keluar.tanggal >= :startDate AND keluar.tanggal <= :endDate";
    }
...
<html lang="en">
    <head>
        ...
        <title>Pengeluaran Produk</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Pengeluaran Produk</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Pengeluaran Produk</li>
                        </ol>
                        <div class="card mb-4">
                            <a type="button" class="btn btn-primary" href="keluar.php">Tambah Pengeluaran</a>
                        </div>
                        <div class="card mb-4">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form method="GET" action="">
                                        ...
                                        <a href="pengeluaran.php" class="btn btn-secondary">Clear Filter</a>
                                    </form>
                                </div>
                            </div>
                        ...
                        <a class="btn btn-sm btn-primary" href="exportpengeluaran.php">Download</a>
                    </div>
                </main>
