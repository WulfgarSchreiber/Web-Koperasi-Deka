...
$sql = "SELECT id, nama_produk, stok, gambar, harga FROM produk WHERE stok > 0";
...
<html lang="en">
  ...
  <div class="collection_text">List Produk</div>
  <div class="collection_section layout_padding">
    	<div class="container">
    		<h1 class="new_text"><strong>Selamat Datang di Koperasi Dua Kelinci</strong></h1>
    	    <p class="consectetur_text">Temukan produk terbaik untuk kebutuhan Anda! ✨ Jelajahi berbagai pilihan, dan dapatkan penawaran terbaik hanya di sini. Selamat Berbelanja! 🛍️</p>
    	</div>
    </div>
									...
									<div class="best_shoes">
										...
										<div class="star_text">
											...
											<div class="right_part">
												<div class="shoes_price"><span style="font-family: 'Georgia'">Stok</span> <span style="font-family: 'Georgia'; color: #04a9eb; font-size: 70%"><?php echo number_format($data['stok']); ?></span></div>
											</div>
											<div class="buy_now_bt">
												<a type="button" href="action.cart.php?action=add&id=<?= $data['id'] ?>" onclick="return confirm('Apakah anda ingin menambahkan produk ini?');"><img src="images/buynow.jpg"></a>
											</div>
										</div>
									</div>
								</div>
